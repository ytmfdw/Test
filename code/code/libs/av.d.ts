...
export class Object extends BaseObject {
  ...
  save(attrs?: any | null, options?: Object.SaveOptions): Promise<this>;
...
export class Conversation extends Object {
  ...
  send(
    fromClient: string,
    message: string | any,
    options?: { transient?: boolean; pushData?: any; toClients?: string[] },
    authOptions?: AuthOptions
  ): Promise<void>;
  broadcast(
    fromClient: string,
    message: string | any,
    options?: { pushData?: any; validTill?: number | Date },
    authOptions?: AuthOptions
  ): Promise<void>;
}
